...
import com.hypertino.hyperbus.model.{Body, DynamicBody, DynamicRequest, Request}
import com.hypertino.hyperbus.serialization.{MessageDeserializer, RequestDeserializer, StringSerializer}
