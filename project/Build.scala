...
object Build extends sbt.Build {
  ...
  lazy val `hyperbus-root` = project.in(file(".")) aggregate(servicebus, `hyperbus-annotations`, `hyperbus-inner`, hyperbus, `hyperbus-akka`, `servicebus-t-distributed-akka`, `hyperbus-cli`)
