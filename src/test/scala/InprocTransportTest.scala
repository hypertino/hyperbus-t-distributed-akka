...
class InprocTransportTest extends FreeSpec with ScalaFutures with Matchers {
  ...
  "InprocTransport " - {
    "Simple Test" in {
      ...
      t.subscribe("a", None, null, null, (s: String) => {
        Future { s.reverse }
      })
    ...
    "NoTransportRouteException Test" in {
      val t = new InprocTransport
      t.subscribe("notexists", None, null, null, (s: String) => {
        Future { s.reverse }
      })
    ...
    "Complex Test (Service and Subscribers)" in {
      ...
      t.subscribe("a", Some("group1"), null, null, group1Func)
      t.subscribe("a", Some("group1"), null, null, group1Func)
      t.subscribe("a", Some("group1"), null, null, group1Func)
      ...
      t.subscribe("a", Some("group2"), null, null, group2Func)
      t.subscribe("a", Some("group2"), null, null, group2Func)
    ...
    "Unsubscribe Test" in {
      val t = new InprocTransport
      val id1 = t.subscribe("a", None, null, null, (s: String) => {
        Future { s.reverse }
      })

      val id2 = t.subscribe("a", None, null, null, (s: String) => {
        Future { s.reverse }
      })
